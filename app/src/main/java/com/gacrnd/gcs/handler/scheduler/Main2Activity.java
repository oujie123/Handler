...
package com.gacrnd.gcs.handler.scheduler;
...
import com.gacrnd.gcs.handler.BuildConfig;
import com.gacrnd.gcs.handler.R;
...
public class Main2Activity extends AppCompatActivity {
    ...
    public void cancelAllJobs(View v) {
        JobScheduler tm = (JobScheduler) getSystemService(Context.JOB_SCHEDULER_SERVICE);
        tm.cancelAll();
        Toast.makeText(Main2Activity.this, R.string.all_jobs_cancelled, Toast.LENGTH_SHORT).show();
    }
    ...
    public void finishJob(View v) {
        ...
        if (allPendingJobs.size() > 0) {
            ...
            Toast.makeText(
                    Main2Activity.this, String.format(getString(R.string.cancelled_job), jobId),
                    Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(
                    Main2Activity.this, getString(R.string.no_jobs_to_cancel),
                    Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private static class IncomingMessageHandler extends Handler {
        ...
        IncomingMessageHandler(Main2Activity activity) {
        ...
        public void handleMessage(Message msg) {
            Main2Activity Main2Activity = mActivity.get();
            if (Main2Activity == null) {
                // Activity is no longer available, exit.
                return;
            }
            View showStartView = Main2Activity.findViewById(R.id.onstart_textview);
            View showStopView = Main2Activity.findViewById(R.id.onstop_textview);
            Message m;
            switch (msg.what) {
                /*
